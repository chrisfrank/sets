...
(function() {
  ...
  go.CLICK_EVENT = Modernizr.touch ? "tap" : "click";

  go.Action = Backbone.Model.extend({
    defaults: function() {
      return {
        title: "",
        id: "",
  ...
  go.ActionView = Backbone.View.extend({
    events: function() {
      if (Modernizr.touch) {
        return {
          "tap": "toggleDone"
    ...
    render: function() {
      this.$el.toggleClass('is_done', this.model.get('done'));
      return this;
    },
    toggleDone: function() {
  ...
  go.ActionList = Backbone.Collection.extend({
    model: go.Action,
...
(function() {
  ...
  go.app.action_list = new go.ActionList;

  $(function() {
    go.app.action_list.fetch();
    return $('.action').each(function() {
      var model, view;
      model = go.app.action_list.get(this.getAttribute('data-id'));
      if (model == null) {
        model = new go.Action({
          title: this.getAttribute('data-title'),
          id: this.getAttribute('data-id')
        });
        go.app.action_list.add(model);
      }
      return view = new go.ActionView({
        model: model,
        el: this
      });
    });
