  ...
  nep.SongView = Backbone.View.extend({
    ...
    ontouchmove: function(e) {
      ...
      if (this.direction === "down") {
        if (this.$el.offset().top >= ((_ref = nextElem.offset()) != null ? _ref.top : void 0)) {
          return this.clone.insertAfter(nextElem);
        }
      } else if (this.direction === "up") {
        if (this.$el.offset().top <= ((_ref1 = prevElem.offset()) != null ? _ref1.top : void 0)) {
          return this.clone.insertBefore(prevElem);
        }
      }
    },
