 ...
 * Build: http://modernizr.com/download/#-flexbox-touch-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes
 */
...
(function() {
  ...
  nep.SongView = Backbone.View.extend({
    ...
    render: function() {
      this.$el.html("<input autocorrect='none' type='text' " + ("value='" + this.model.attributes.name + "'/>") + "<div class='handle'><i class='icon-list'></i></div>").hammer();
      return this;
    },
    edit: function(e) {
      e.stopPropagation();
      return this.$el.addClass('is_editing').find('input').focus();
    },
    done: function(e) {
      var name;
      e.stopPropagation();
      if (e.keyCode === 13) {
        ...
        return this.render().$el.removeClass('is_editing');
      }
    },
    "delete": function(e) {
  ...
  nep.SetList = Backbone.Collection.extend({
    ...
    initialize: function() {
      return this.view = new nep.SetListView({
        collection: this
      });
    },
  ...
  nep.SetListView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      this.src = this.srcIndex = this.dstIndex = null;
      return this.render();
    },
    render: function() {
      ...
      return this.$el.sortable({
        ...
        cursor: "move",
        stop: function(e) {
          return _this.collection.repositionAll();
        }
      });
    },
    newSong: function() {
    ...
    remove: function(song) {
      return $("#song_" + song.id).slideUp(function() {
        return $(this).remove();
      });
    }
  });
  ...
  $(function() {
    ...
    return $("#send a").on('click', function(e) {
      ...
      $(nep.app.list.models).each(function() {
        return songs += "" + this.attributes.name + "\n";
      });
      return $(this).attr('href', "mailto:?subject=Setlist&body=" + (encodeURIComponent(songs)));
    });
  });
